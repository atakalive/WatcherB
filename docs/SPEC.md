...
DevBarパイプラインの進捗をリアルタイム監視するデスクトップGUI。
Discord #dev-bar チャンネルのメッセージを受信し、プロジェクトごとのパイプライン状態を可視化する。

## 動機

- devbarの進捗確認にDiscordクライアントを開く必要がある
